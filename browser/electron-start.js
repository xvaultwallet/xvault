...
/*webPreferences: { 
  ...
  The above is necessary to use require in index.html after Electron v5. Note that this is not ideal as it could be exploited by XSS attacks if remote pages were opened in the app*/
...
mainWindow.on('did-finish-load', function () {
  ...
  mainWindow.on('did-fail-load', function () {
    console.log("window failed loading");
  });
  ...
  console.log("requested url");
	...
	//Uncomment line below to show console etc for debugging
	mainWindow.webContents.openDevTools()
...
var onlyInstance = app.requestSingleInstanceLock();
